...
ChoiceAdminField::$arr_options_formated=array(0 => admin_l('Administrator'), 1 => admin_l('Moderator'));

ChoiceAdminField::$arr_options_select=array(1, admin_l('Administrator'), 0, admin_l('Moderator'), 1);
